      ...
      <header className="flex flex-col gap-5 md:gap-8">
        <Link href="/" className=" cursor-pointer flex items-center gap-4">
          <Image
            ...
            alt="Orbitt logo"
          />
          <h1 className="text-26 font-lato font-bold text-gray-700">Orbitt</h1>
        </Link>
...
//               alt="Horizon logo"
//             />
//             <h1 className="text-26 font-lato font-bold text-black-1">Orbitt</h1>
//           </Link>
